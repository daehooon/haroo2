						...
						<div class="mb-3" id="har-feed-file">
							...
							<div class="har-file-box">
								<div class="har-file-box2">
									<input class="form-control form-control-sm" name="files"
										type="file">
									<button type="button" class="btn btn-outline-secondary"
										onclick="fileDeleteBtn(event)" class="har-delete-btn">삭제</button>
								</div>
							</div>
							<button type="button" class="btn2 btn-outline-secondary"
								id="har-add-btn">추가</button>
						</div>

						<p class="text-start">
							<span class="har-feed-check">확인해주세요!</span> <br> - 이미지만 업로드
							가능합니다.<br> - 첫번째로 선택하신 이미지가 피드의 섬네일로 보여집니다.<br> - 최소 1장
							이상의 이미지를 업로드하셔야 합니다.<br> - 업로드 이미지는 최대 10장 입니다.<br> -
